class BoxesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @box.save
        format.html { redirect_to(project_path(@box.project.id), :notice => 'Module was successfully created.') }
  ...
  def admin_update
    ...
    respond_to do |format|
      if @box.update_attributes(params[:box])
        format.html { redirect_to(@box.project, :notice => 'Box was successfully updated.') }
        format.xml  { head :ok }
      else
